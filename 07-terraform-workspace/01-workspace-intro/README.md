...
**Ans :** - A developer is working a on complex set of infrastructure chainges 
          ...
          - terraform will not recomemnd using the workspace for large infractures inline with enveronmental patterns like **DEV**,**QA**,**STAGING** Recomended to use Seperate 
