...
- terraform resource targetting (-target) specifically targetting specific resource in terraform configuration Apply the chainges to that specific resource 
